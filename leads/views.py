...
from .forms import LeadModelForm, CustomUserCreationForm, AssignAgentForm, LeadCategoryUpdateForm # LeadForm
...
class LeadCreateView(OrganiserLoginRequiredMixin, generic.CreateView):
    ...
    def form_valid(self, form):
        ...
        send_mail(
            ...
            from_email="udofaabasiama20@gmail.com",
            recipient_list=["nattybizzh@gmail.com"]
        )
...
#          agent = Agent.objects.first() #grabs the first row in the table
